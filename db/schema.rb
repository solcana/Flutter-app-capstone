...
ActiveRecord::Schema[7.0].define(version: 2023_03_08_123319) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.bigint "travel_log_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["travel_log_id"], name: "index_comments_on_travel_log_id"
  ...
  add_foreign_key "comments", "travel_logs"
